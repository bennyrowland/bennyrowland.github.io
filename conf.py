...
BLOG_AUTHOR = "Ben Rowland"  # (translatable)
BLOG_TITLE = "Suspect Research"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://bennyrowland.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://bennyrowland.github.io/"
BLOG_EMAIL = "bennyrowland@mac.com"
BLOG_DESCRIPTION = "Scientific programming in Python and lessons learned along the way"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "bennyrowland-github-io"
